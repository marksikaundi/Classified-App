        ...
        <div className="flex flex-col border rounded-lg shadow-xl border-[#BDBDBD] bg-[#2B3C96] md:mx-40">
          ...
          <div className="bg-white text-black py-20 px-10 space-y-5">
            ...
            <p>
              ...
              agree to these terms, you have no right to continue using our
            ...
            <h2 className="font-bold">
              5. Your use of Classified app and our Marketplace
            </h2>
            ...
            <div className="font-bold">
              <p>
                ...
                of Classified App or our Marketplace;
              </p>
              <p>
              ...
              <p>
                (f) in any way tamper with, hinder or modify Classified App or
                our Marketplace;
              </p>
              <p>
                (g) knowingly transmit any viruses or other disabling features
                to Classified App or the Marketplace;
              </p>
              <p>
                (h) intentionally disable or circumvent any protection or
                disabling mechanism related to Classified App;
              </p>
              <p>
                (i) install or store any software applications, code or scripts
                on Classified App or the Marketplace;
              </p>
              <p>
                (j) use Classified App in any way which could be reasonably
            ...
            <p>
              ...
              our service providers services, our Marketplace may be disrupted.
            </p>
              ...
              <table className="table-auto border-collapse border">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border md:p-4">Post is flagged as expired.</td>
                  </tr>
                  <tr>
