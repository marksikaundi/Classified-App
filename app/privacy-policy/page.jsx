        ...
        <div>
            <div className='w-4/5 shadow-md h-auto m-auto mb-10'>
                ...
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    <p>
                    While your Privacy is important to us, nothing in this Privacy Policy constitutes a voluntary opt in
                    to any privacy laws, anywhere in the world, which we are not statutorily bound to comply with.
                    </p>
                </div>
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    for prosperity (Marketplace). Personal Information is collected when you:
                    <br />
                    <br />
                    <b>
                    ...
                    Information will only be collected directly from you unless you authorise another person to provide the information. <br />
                    </b>
                    </p>
                </div>
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    device identification and any additional information you provide to us.
                    </p>
                    <br />
                    <br />
                    <p>
                    Where you contact us on behalf of your employer, the information you provide
                    often contains information about your employment, position and employers
                    contact details. In those circumstances certain employment information is collected.
                    </p>
                </div>
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    closely related to the primary purpose, in circumstances where you would reasonably expect
                    ...
                    (b) contacting you regarding your listing, including any inquiries you have received; <br />
                    (c) providing you with access to our products and services; <br />
                    (d) administration needs in relation to providing you with access to our platform, including the administration of your account; <br />
                    (e) dealing with requests, enquiries or complaints and other customer care related activities; and <br />
                ...
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    we send you marketing communications by push notifications, by email and SMS about listings
                    and our platform that we feel may be of interest to you.
                    <br />
                    <br />
                    We (or an appointed third party) may also conduct surveys or market research
                    and may seek other information from you on a periodic basis. These surveys will
                    provide us with information that allows improvement in the type, quality and the
                    manner in which our goods and services are offered to you.
                    <br />
                    <br />
                ...
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    we collect through our services. However, we will only distribute data which has been
                    de-identified or as otherwise set out in accordance with this Policy.
                    </p>
                </div>
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    ...
                    (d) the name of your internet service provider may be captured depending on the configuration of your connection; <br />
                    (e) the date, time and duration of your visit to the website; <br />
                    (f) the number of times you access our site within any month; <br />
                    (g) the operating system of your computer or mobile device; and <br />
                ...
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    <h1>6. Data retention and security 6.1 Security mechanisms we employ</h1> <br />
                    <p>
                    Generally, we store your Personal Information using secure servers protected from unauthorised access, modification and disclosure. The bulk of our structured data is stored in databases encrypted at rest. However, like most businesses we hold some information on our staff’s computers (such as emails from you) and where necessary as hard copy files (such as printed invoices).
                    <br />
                    <br />
                    Our systems are located across Australia and Singapore and are managed by us and our service providers. Personal Information that we store or transmit is protected by security and access controls, including username and password authentication, two-factor authentication, and data encryption (such as SSL) where appropriate.
                    <br />
                    <br />
                ...
                <div className='grid grid-col-1 justify-center text-start h-auto mt-5'>
                    <h1>7. Disclosure of your Personal Information 7.1 Who we share your Personal Information with?</h1> <br />
                    <p>
                    Your Personal Information may be disclosed to:
                    <br />
                    <br />
                    <b>
                    (a) our employees, a related company and our professional advisers (lawyers, accountants, financial advisers etc.); <br />
                    (b) regulators and government authorities in connection with our compliance procedures and obligations, including law enforcement agencies to assist in the investigation and prevention of criminal activities; <br />
                    (c) a third party, in order to enforce or defend our rights, or to address financial or reputational risks; <br />
                    (d) a rights holder in relation to an allegation of intellectual property infringement; <br />
                    (e) third party contractors, suppliers and service providers with whom we have a business association, including:
                    </b>
                    (i) payment gateway providers, such as PayPal Holdings Inc.; <br />
                    (ii) software developers; <br />
                    (iii) administration service providers; <br />
                    (iv) marketing service providers; and  <br />
                    (v) information technology service providers including cloud application providers.
                    <br />
                    <br />
                    We will not disclose your Personal Information other than in accordance with this Policy without your consent. 7.2 Offshore transfers
                    We may disclose your Personal Information to third party contractors, service providers and suppliers with whom we have a business association who operate in Australia, Singapore and Pakistan.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <b>Note:</b> When you provide personal information in a listing, you are consenting to us publishing that information throughout the world. It is your responsibility to consider what information is appropriate to share.
